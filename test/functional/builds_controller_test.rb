...
class BuildsControllerTest < ActionController::TestCase
  ...
  test "should create build" do
    assert_difference('Build.count') do
      post :create, build: { application: @build.application, environment: @build.environment,  launched_at: @build.launched_at, notes: @build.notes }
    end
  ...
  test "should update build" do
    put :update, id: @build, build: { application: @build.application, environment: @build.environment,  launched_at: @build.launched_at, notes: @build.notes }
    assert_redirected_to build_path(assigns(:build))
  end
